...
double get_contact_qual(emokit_device* d,int chan)
{
    return d->contact_quality[chan];
}

int get_counter(emokit_device* d)
{
    return d->current_counter;
}

int get_battery(emokit_device* d)
{
    return d->battery;
}
